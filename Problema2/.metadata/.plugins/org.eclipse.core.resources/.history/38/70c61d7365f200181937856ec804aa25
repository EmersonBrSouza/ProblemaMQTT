...
#define MQTT_CONNECT_SIZE "AT+CIPSEND=27\r\n"
#define MQTT_CONNECT "\x10\x12\x01\x04\aMQTT\x04\x02\x01\x14\x01\x06\atest/test\r\n"

#define MESSAGE_SIZE "AT+CIPSEND=22\r\n"
#define MESSAGE_0 "\x30\x13\x01\x06\aPBL 02Mensagem 01"
#define MESSAGE_1 "\x30\x13\x01\x06\aPBL 02Mensagem 02"
#define MESSAGE_2 "\x30\x13\x01\x06\aPBL 02Mensagem 03"
#define MESSAGE_3 "\x30\x13\x01\x06\aPBL 02Mensagem 04"
#define MESSAGE_4 "\x30\x13\x01\x06\aPBL 02Mensagem 05"

#define MQTT_DISCONNECT_SIZE "AT+CIPSEND=4\r\n"
#define MQTT_DISCONNECT "\xe0\x01\r\n"
