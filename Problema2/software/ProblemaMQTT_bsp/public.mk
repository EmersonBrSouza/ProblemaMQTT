...
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../lcd.sopcinfo
...
# setting hal.stderr is uart_main
ELF_PATCH_FLAG  += --stderr_dev uart_main

# Slave descriptor of STDIN character-mode device. This setting is used by the 
# ALT_STDIN family of defines in system.h. none 
# setting hal.stdin is uart_main
ELF_PATCH_FLAG  += --stdin_dev uart_main
...
# setting hal.stdout is uart_main
ELF_PATCH_FLAG  += --stdout_dev uart_main
